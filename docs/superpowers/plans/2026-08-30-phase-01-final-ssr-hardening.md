...
- [x] **Step 2: Verify the pinned `setAll` signature**
...
- [x] **Step 3: Preserve the Server Component boundary**
...
- [x] **Step 1: Capture the cookie adapter and simulate Supabase refresh**
...
- [x] **Step 1: Add the typed headers parameter**
...
- [x] **Step 1: Run every requested local gate on the final candidate**
...
- [x] **Step 2: Update the phase report**
...
- [x] **Step 3: Commit and push only the requested branch**
...
- [x] **Step 4: Verify the new remote run and stop**
