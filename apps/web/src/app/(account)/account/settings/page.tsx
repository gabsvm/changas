  ...
  return (
    <section className="pb-4 sm:py-14">
      ...
      <div className="mx-auto max-w-2xl pt-6 sm:pt-0">
        ...
        <section className="border-ink/10 bg-surface mt-5 overflow-hidden rounded-3xl border">
          <Link
            href="/account/notifications"
            className="border-ink/10 hover:bg-ink/3 flex min-h-14 items-center justify-between gap-4 border-b px-5 py-3 text-sm font-semibold transition-colors"
          >
          ...
          <Link
            ...
            className="hover:bg-ink/3 flex min-h-14 items-center justify-between gap-4 px-5 py-3 text-sm font-semibold transition-colors"
          >
