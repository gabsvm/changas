    ...
    <section className="space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-600">
          Reportes preservados, decisiones reversibles y evidencia sin borrado
          destructivo.
        </p>
      </div>
      <form
      ...
      >
        <h3 className="font-bold">Moderación puntual de mensaje</h3>
      ...
      <div>
        <h3 className="mb-3 text-lg font-bold">Reportes abiertos</h3>
      ...
      <div>
        <h3 className="mb-3 text-lg font-bold">Historial resuelto</h3>
