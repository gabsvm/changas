...
insert into auth.users (
  ...
  ('00000000-0000-0000-0000-000000000000', '11000000-0000-4000-8000-000000000001', 'authenticated', 'authenticated', 'phase11-reconcile-client@example.test', 'not-a-real-password', now(), now(), now(), '{}', '{"display_name":"Phase11 Client"}'),
  ('00000000-0000-0000-0000-000000000000', '11000000-0000-4000-8000-000000000002', 'authenticated', 'authenticated', 'phase11-reconcile-provider@example.test', 'not-a-real-password', now(), now(), now(), '{}', '{"display_name":"Phase11 Provider"}');
...
insert into public.proposal_versions (
  ...
  (
    ...
    'REMOTE',
    'Synthetic success reconciliation scope',
    'FIXED',
    100000,
    'ARS',
    'UNSCHEDULED'
  ...
  (
    ...
    'REMOTE',
    'Synthetic failed reconciliation scope',
    'FIXED',
    100000,
    'ARS',
    'UNSCHEDULED'
...
insert into public.payment_provider_accounts (
  ...
  'MERCADO_PAGO',
  'seller-phase11-001',
  'ciphertext-access-phase11',
  'iv-access-phase11',
  'tag-access-phase11',
  'ciphertext-refresh-phase11',
  'iv-refresh-phase11',
  'tag-refresh-phase11',
  1,
  'CONNECTED'
