...
insert into public.services (
  ...
  ('24000000-0000-4000-8000-000000000001', '23000000-0000-4000-8000-000000000001', '22000000-0000-4000-8000-000000000003', 'demo-revision-pc', 'Revisión de PC a distancia', 'Diagnóstico inicial y recomendaciones claras para tu equipo.', 'REMOTE', 'FIXED', 12500, 'ARS', null, false, 60, 'UNSCHEDULED', 'Informe sintético de diagnóstico', true, 10),
  ('24000000-0000-4000-8000-000000000002', '23000000-0000-4000-8000-000000000001', '22000000-0000-4000-8000-000000000004', 'demo-soporte-remoto', 'Soporte técnico remoto', 'Ayuda guiada para resolver problemas habituales de software.', 'BOTH', 'STARTING_AT', 9000, 'ARS', null, true, 45, 'FLEXIBLE_WINDOW', 'Sesión inicial de orientación', true, 20),
  ('24000000-0000-4000-8000-000000000003', '23000000-0000-4000-8000-000000000001', '22000000-0000-4000-8000-000000000010', 'demo-diseno-hora', 'Diseño gráfico por hora', 'Diseño de piezas visuales simples para proyectos y comercios.', 'REMOTE', 'HOURLY', 15000, 'ARS', null, true, 120, 'DEADLINE', 'Una ronda de ajustes', true, 30),
